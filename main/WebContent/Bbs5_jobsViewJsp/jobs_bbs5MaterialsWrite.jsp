...
<head>
	...
	<title>jobs_bbs5MaterialsWrite.jsp.jsp</title>
...
<div class="wrap">
		...
		<form action="../BBSmaterialsController" method="get" enctype="multipart/form-data">
		<table border="1">
			...
			<tr>
				...
				<td>
					...
					<input type="hidden" name="command" value="MaterialswriteAf">
			...
			<tr>
				<td>Tag</td>
				<td>
					<input type="text" size="50" id="tag" name="tag" value="자료실" 
			...
			<tr>
				<td colspan="2">
					...
					onclick="location.href='../BBSmaterialsController?command=MaterialsBbs'">
				</td>
			</tr>
		</table>
		</form>
